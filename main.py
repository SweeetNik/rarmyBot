...
a = 38
while a > 1:
    api.wall.post(owner_id='-195777168', message="Димас еще в армии\nДимасу осталось служить " + str(a) + " дней", attachments='photo201342171_456272777', v=5.90)
    print(a)
    a -= 1
    time.sleep(86400)
    if a == 1:
        api.wall.post(owner_id='-195777168', message="Димас ДЕМБЕЛЬНУЛСЯ", attachments='photo201342171_456272777', v=5.90)
        break
